...
class ContactHelper:
    ...
    def fill_new_entry(self, contact):
        wd = self.app.wd
        self.add_new_entry()
        # fill contact form
    ...
    def fill_contact(self, contact):
        ...
        Select(wd.find_element_by_name("amonth")).select_by_visible_text(contact.bmonth)
    ...
    def get_contact_list(self):
        ...
        for element in wd.find_elements_by_name('entry'):
            ...
            contacts.append(Contact(_first_name=first_name, _last_name=last_name, _id=id))
        return contacts